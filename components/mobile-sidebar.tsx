...
export function MobileSidebar({ isOpen, onClose }: MobileSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-slate-900/95 backdrop-blur-md border-l border-amber-500/20 z-50 md:hidden transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex items-center justify-between p-6 border-b border-amber-500/20">
          <div className="flex items-center space-x-3 group">
            ...
            <div className="transform transition-all duration-300 group-hover:translate-x-1">
              <h1 className="text-lg font-bold text-white bg-gradient-to-r from-white to-amber-200 bg-clip-text text-transparent">
